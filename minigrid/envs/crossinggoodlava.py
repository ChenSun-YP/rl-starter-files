...
from minigrid.core.world_object import Goal, Good_lava
from minigrid.minigrid_env import MiniGridEnv

# in this lava is the goal!
class CrossinggoodlavaEnv(MiniGridEnv):
